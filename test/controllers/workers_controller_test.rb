...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { email: @worker.email, name: @worker.name, title: @worker.title } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { email: @worker.email, name: @worker.name, title: @worker.title } }
